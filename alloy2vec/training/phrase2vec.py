...
import gensim
from alloy2vec.training.helpers.utils import EpochSaver, compute_epoch_accuracies, \
...
from my_process import get_sentences
...
if __name__ == "__main__":
    ...
    sentences=get_sentences(args.corpus)
    #print("LineSentence ",sentences)
    ...
    if not args.notmp:
        ...
        callbacks = []
    print("start model training........print processed sentences..........")
    print("sg: ",bool(args.sg))
    #for topic in processed_sentences:
    #  print(topic)
    #print(sentences)
    my_model = Word2Vec(
        sentences,
        size=int(args.size), #vector_size for v.4.1.2
        ...
        iter=int(args.epochs), #epoch for v4.1.2
        callbacks=callbacks)
